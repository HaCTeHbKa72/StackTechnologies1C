...
- [Разработка](#разработка)
  - [Языки программирования](#языки-программирования)
    ...
    - [1C:Предприятие.Элемент Скрипт. (бывший 1С:Исполнитель)](#1cпредприятиеэлемент-скрипт-бывший-1сисполнитель)
    - [OneScript](#onescript)
  - [IDE](#ide)
...
- [Прочие технологии и полезные ссылки](#прочие-технологии-и-полезные-ссылки)
  ...
  - [Прочие технологии](#прочие-технологии)
    ...
    - [Мониторинг и аналитика](#мониторинг-и-аналитика)
      ...
      - [Elasticsearch (ELK-стек)](#elasticsearch-elk-стек)
...
### 1C:Предприятие.Элемент Скрипт. (бывший 1С:Исполнитель)
...
Нужен для автоматизации рутинных задач и администрирования. Имеет преимущества перед традиционными командными интерпретаторами.
Условный python или OneScript но с синтаксисом Элемента.

**С чего начать:**

1. Документация - [Что такое 1С:Предприятие.Элемент Скрипт](https://1cmycloud.com/console/help/lang/docs/topics/what-is-1c-element-script/)
2. Среда разработки - [https://1cmycloud.com/console/play]
3. Статья на зазеркалье - [1С-Исполнитель](https://wonderland.v8.1c.ru/blog/1c-ispolnitel/)
...
Онлайн-сервис для разработки и управления проектами.
...
Для крупных внедрений и проектов с повышенными требованиями к стабильности и производительности полезно использовать системы мониторинга и анализа данных, которые работают совместно с 1С:Предприятием и сопутствующей инфраструктурой

Эти инструменты пока не являются массовыми среди 1С-разработчиков, но могут быть крайне полезны администраторам, DevOps-инженерам и интеграторам в крупных проектах

![Мониторинг и аналитика](<img/Мониторинг и аналитика.png>)

#### Zabbix

Классическая система мониторинга серверов и служб. Позволяет отслеживать доступность серверов 1С, состояние служб `ras` / `rmngr`, загрузку CPU, память, дисковое пространство и другие параметры.  

Подробнее: [https://www.zabbix.com/ru](https://www.zabbix.com/ru)

#### Prometheus + Grafana

Prometheus собирает метрики (нагрузка сервера 1С, количество сеансов, производительность PostgreSQL и других компонентов), а Grafana визуализирует их в удобных интерактивных дашбордах.  
...
Инструмент для централизованного сбора, хранения и поиска логов (1С, веб-сервисы, интеграции). Удобен для анализа ошибок, аудита действий и расследования инцидентов.  

Подробнее: <https://www.elastic.co/>

#### ClickHouse

Высокопроизводительное аналитическое хранилище данных. Подходит для построения сложных отчётов и BI-аналитики на больших объёмах данных, в том числе на данных, выгруженных из 1С.  

Подробнее: <https://clickhouse.com/>

[В начало](#прочие-технологии)
...
Буду рад вашим улучшениям и дополнениям! Можете создать issue к репозиторию или самостоятельно внести изменения.

**Как внести изменения:**

1. Сделайте **fork** репозитория
2. Внесите изменения, добавьте описание инструмента или технологии
3. Создайте pull request в мой репозиторий с описанием своих изменений

**Рекомендации:**

- Следуйте существующей структуре README и стиля оформления
- Проверяйте орфографию и ссылки
- Добавляйте примеры и ссылки на документацию
